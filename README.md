...
Before upgrading, exit the older desktop process so it releases loopback port `19828`. The v0.1.16 UI checks the connected Worker version and disables live mode when an older Worker or an unconfigured contract is still running.
